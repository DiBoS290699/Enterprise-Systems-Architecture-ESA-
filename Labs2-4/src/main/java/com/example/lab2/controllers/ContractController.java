...
public class ContractController {
    ...
    @RequestMapping(value = "/", method = RequestMethod.GET, headers="accept=application/json") // GET localhost:8080/order/
    ...
    public ModelAndView getOrdersXSLT() throws JsonProcessingException {
        List<Contract> orders = contractService.findAll();
