...
public class EmployeeController {
    ...
    @RequestMapping(value = "/", method = RequestMethod.GET, headers="accept=application/json") // GET localhost:8080/employee/
    ...
    public ModelAndView getEmployeesXSLT() throws JsonProcessingException {
        List<Employee> employees = employeeService.findAll();
        ModelAndView modelAndView = new ModelAndView("employees");
        Source source = new StreamSource(new ByteArrayInputStream(new XmlMapper().writeValueAsBytes(employees)));
